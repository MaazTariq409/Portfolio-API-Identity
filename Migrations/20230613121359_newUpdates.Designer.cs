...
namespace Portfolio_API.Migrations
{
    ...
    [Migration("20230613121359_newUpdates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio_API.Models.UserProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio_API.Models.UserServiceGig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("userServiceGigs");
                });

            modelBuilder.Entity("Portfolio_API.Models.UserServices", b =>
                {
                    b.Property<int>("ServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio_API.Models.UserProfile", b =>
                {
                    b.HasOne("Portfolio_API.Models.IdentityManual", "user")
                        .WithOne("UserProfile")
                        .HasForeignKey("Portfolio_API.Models.UserProfile", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Portfolio_API.Models.UserServiceGig", b =>
                {
                    b.HasOne("Portfolio_API.Models.UserServices", "services")
                        .WithMany()
